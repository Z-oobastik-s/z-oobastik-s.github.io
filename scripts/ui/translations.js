...
window.translations = {
    ru: {
        ...
        chapterBriefingTrackLine: 'Базовый трек этой главы: {{done}} / {{total}}.',
        sagaHubPulseTitle: 'Статус кампании (язык уроков)',
        sagaHubChapter1: 'Глава I',
        sagaHubChapter2: 'Глава II',
        sagaHubChapter3: 'Глава III',
        sagaHubProgressPiece: '{{done}} / {{total}}',
        sagaHubLockedPiece: 'закрыта',
        tierLockTeaserMedium: 'Внутри ждут заглавные, длинные отрезки и темп как на треке.',
        tierLockTeaserAdvanced: 'Внутри ждут знаки препинания, марафоны и настоящий финал сезона.',
        sagaToastChapter2Unlocked: 'Глава II открыта. Режим перегруза на связи.',
        sagaToastChapter3Unlocked: 'Глава III в доступе. Точка невозврата - твой вызов.',
        sagaToastCampaignComplete: 'Кампания на этой раскладке уроков закрыта. Ты прошёл весь сюжет.',
        resultCampaignNextHint: 'Следующая миссия уже на карте - не дай ей остыть.',
        ...
        lessonsSagaUnlockLine: 'Уроки открываются по цепочке: пройди предыдущий, чтобы разблокировать следующий. Новая глава кампании (средний и выше) - после всей предыдущей на этой раскладке.',
        lessonLockedToast: 'Сначала пройди предыдущий урок по сюжету.',
        ...
        sagaBeat1: 'Ритм выровнен. Следующий блок проверит, помнят ли пальцы дорогу.',
        sagaBeat2: 'Канал стабильнее. Нагрузка растёт, а ты держишь линию.',
        sagaBeat3: 'Темп поднимается. Дыши ровно, печатай чище, не срывайся.',
        sagaBeat4: 'Ядро сюжета: здесь проверяют характер и выносливость.',
        sagaBeat5: 'Финишная прямая акта. Покажи, что мышечная память уже твоя.',
        sagaBeatBeginner0: 'Пробуждение: первая буква в цепи не ждёт оправданий.',
        sagaBeatBeginner1: 'Базовый ряд встаёт на места - слушай такт системы.',
        sagaBeatBeginner2: 'Верх и низ подключаются к сети. Не отрывай взгляд от строки.',
        sagaBeatBeginner3: 'Каждый знак - точка на маршруте. Ты уже внутри миссии.',
        sagaBeatBeginner4: 'Ритм уроков плотнее - мышечная память просыпается.',
        sagaBeatBeginner5: 'Конец акта: докажи, что руки помнят путь без карты.',
        sagaBeatMedium0: 'Перегруз: Shift и длина строки меняют правила игры.',
        sagaBeatMedium1: 'Темп растёт - слабые ошибки дорого стоят.',
        sagaBeatMedium2: 'Канал держится, если дышишь ровно и не срываешь фокус.',
        sagaBeatMedium3: 'Здесь проверяют: ты ещё новичок или уже боец клавиатуры.',
        sagaBeatMedium4: 'Пик акта - длинные отрезки без паники.',
        sagaBeatMedium5: 'Финиш ближе к главе III. Не сливай темп на последних метрах.',
        sagaBeatAdvanced0: 'Точка невозврата: пунктуация, длина, нерв.',
        sagaBeatAdvanced1: 'Текст давит - ты давишь в ответ. Ищи баланс.',
        sagaBeatAdvanced2: 'Марафон без права на слабину.',
        sagaBeatAdvanced3: 'Тут не «попробовал» - либо клир, либо нет.',
        sagaBeatAdvanced4: 'Почти у финала сезона. Покажи характер.',
        sagaBeatAdvanced5: 'Финал кампании на этой раскладке. Заслужи титул.',
        ...
        profileNicknameEmpty: 'Укажите никнейм',
        ...
        collectiblesNewCard: 'Новая карта!',
        collectiblesDuplicate: 'Дубликат - компенсация монетами',
        collectiblesOpenError: 'Не удалось открыть бустер',
        collectiblesLogin: 'Войди, чтобы собирать карты.',
        collectiblesClose: 'Круто!',
        collectiblesHomeDesc: 'Бустеры, редкости и бонус к монетам',
        collectiblesChanceValue: 'Шанс: {{pct}}%',
        collectiblesCardChanceTitle: 'Скрытая карта. Шанс из бустера: {{pct}}%.',
        collectiblesFlipMicro: 'Один бустер - один дроп',
        collectiblesBooster10: '10 бустеров',
        collectiblesBooster50: '50 бустеров',
        collectiblesBatchTitle: 'Открыто бустеров: {{n}}',
        collectiblesBatchSummary: 'Новых: {{newN}}, дубликатов: {{dupN}}, компенсация: +{{coins}} монет',
        collectiblesBatchNew: 'Новая',
        collectiblesBatchDup: 'Дубликат',
        collectiblesBatchToast: '+{{coins}} монет · новых {{newN}}, дубликатов {{dupN}}',
        collectiblesBatchClose: 'Закрыть',
        collectiblesRarity_common: 'Обычная',
        collectiblesRarity_uncommon: 'Необычная',
        collectiblesRarity_rare: 'Редкая',
        collectiblesRarity_mythic: 'Мифическая',
        collectiblesLegendTitle: 'Редкости и дроп',
        collectiblesLegendLead: 'Каждое открытие бустера выдаёт одну случайную карту. У слота в колоде есть вес: чем дальше карта по порядку в сетке, тем ниже вес и тем реже она падает. Ниже - четыре уровня и доля всех открытий по ярусу (сумма шансов карт этого уровня).',
        collectiblesLegendCommon: 'Самые частые. Около 39% всех открытий бустера приходится на обычные карты.',
        collectiblesLegendUncommon: 'Реже обычных. Около 33% открытий.',
        collectiblesLegendRare: 'Заметно реже. Около 20% открытий.',
        collectiblesLegendMythic: 'Топ редкость. Около 9% открытий - за ними охотятся коллекционеры.',
        ...
        resultProgressNoBaseline: 'Сравнение - со 2-го захода',
        resultProgressBeatPrev: '+{{delta}}% к прошлому ({{prev}}%→{{curr}}%)',
        resultProgressBehindPrev: '{{delta}}% к прошлому ({{prev}}%→{{curr}}%)',
        resultProgressTiePrev: 'Как в прошлый: {{prev}}%',
        resultProgressCharsLine: '{{typed}} / {{total}} симв.',
        resultProgressCharsShort: '{{typed}}/{{total}}',
    ...
    en: {
        ...
        chapterBriefingTrackLine: 'Core track progress: {{done}} / {{total}}.',
        sagaHubPulseTitle: 'Campaign status (lesson language)',
        sagaHubChapter1: 'Chapter I',
        sagaHubChapter2: 'Chapter II',
        sagaHubChapter3: 'Chapter III',
        sagaHubProgressPiece: '{{done}} / {{total}}',
        sagaHubLockedPiece: 'locked',
        tierLockTeaserMedium: 'Inside: capitals, longer runs, and pace that feels like a circuit.',
        tierLockTeaserAdvanced: 'Inside: punctuation, marathons, and the real season finale.',
        sagaToastChapter2Unlocked: 'Chapter II is live. Overdrive is online.',
        sagaToastChapter3Unlocked: 'Chapter III unlocked. Point of no return - your call.',
        sagaToastCampaignComplete: 'Campaign cleared on this lesson layout. You ran the full story.',
        resultCampaignNextHint: 'The next mission is already on the map - do not let it cool down.',
        ...
        lessonsSagaUnlockLine: 'Lessons unlock in order: finish the previous one to open the next. The next campaign tier unlocks after you clear the whole previous tier on this layout.',
        lessonLockedToast: 'Finish the previous story lesson first.',
        ...
        sagaBeat1: 'Steady rhythm. The next block checks whether your fingers still know the way.',
        sagaBeat2: 'Channel holds. Load goes up - you keep the line clean.',
        sagaBeat3: 'Tempo rises. Breathe even, type cleaner, do not tilt.',
        sagaBeat4: 'Core beat: this is where grit and stamina get tested.',
        sagaBeat5: 'End of the act. Show that muscle memory is already yours.',
        sagaBeatBeginner0: 'Wake-up call: the first key in the chain does not wait for excuses.',
        sagaBeatBeginner1: 'Home row locks in - ride the system metronome.',
        sagaBeatBeginner2: 'Top and bottom rows join the network. Eyes on the line.',
        sagaBeatBeginner3: 'Every character is a waypoint. You are inside the run now.',
        sagaBeatBeginner4: 'Lesson rhythm tightens - muscle memory boots up.',
        sagaBeatBeginner5: 'Act break: prove your hands know the route without a map.',
        sagaBeatMedium0: 'Overload: Shift and longer lines change the rules.',
        sagaBeatMedium1: 'Tempo climbs - sloppy mistakes cost more.',
        sagaBeatMedium2: 'The channel holds if you breathe even and keep focus.',
        sagaBeatMedium3: 'This block asks if you are still a rookie or already a fighter.',
        sagaBeatMedium4: 'Act peak: long stretches without panic.',
        sagaBeatMedium5: 'Finale of the arc nears Chapter III. Do not throw tempo at the line.',
        sagaBeatAdvanced0: 'Point of no return: punctuation, length, nerves.',
        sagaBeatAdvanced1: 'The text pushes - you push back. Find balance.',
        sagaBeatAdvanced2: 'Marathon mode: no room for weak reps.',
        sagaBeatAdvanced3: 'No "I tried" here - clear or reset.',
        sagaBeatAdvanced4: 'Near the season exit. Show grit.',
        sagaBeatAdvanced5: 'Campaign finale on this layout. Earn the title.',
        ...
        profileNicknameEmpty: 'Enter a nickname',
        ...
        collectiblesNewCard: 'New card!',
        collectiblesDuplicate: 'Duplicate - coin refund',
        collectiblesOpenError: 'Could not open booster',
        collectiblesLogin: 'Log in to collect cards.',
        collectiblesClose: 'Nice!',
        collectiblesHomeDesc: 'Boosters, rarities & coin bonus',
        collectiblesChanceValue: 'Chance: {{pct}}%',
        collectiblesCardChanceTitle: 'Hidden card. Booster drop chance: {{pct}}%.',
        collectiblesFlipMicro: 'One booster - one pull',
        collectiblesBooster10: '10 boosters',
        collectiblesBooster50: '50 boosters',
        collectiblesBatchTitle: 'Opened boosters: {{n}}',
        collectiblesBatchSummary: 'New: {{newN}}, duplicates: {{dupN}}, refund: +{{coins}} coins',
        collectiblesBatchNew: 'New',
        collectiblesBatchDup: 'Duplicate',
        collectiblesBatchToast: '+{{coins}} coins · {{newN}} new, {{dupN}} dupes',
        collectiblesBatchClose: 'Close',
        collectiblesRarity_common: 'Common',
        collectiblesRarity_uncommon: 'Uncommon',
        collectiblesRarity_rare: 'Rare',
        collectiblesRarity_mythic: 'Mythic',
        collectiblesLegendTitle: 'Rarities and drop',
        collectiblesLegendLead: 'Each booster opening gives one random card. Cards have pull weights: the later a card sits in the full deck order on the grid, the lower its weight and the rarer the drop. Below: four tiers and their share of all openings (sum of chances for cards in that tier).',
        collectiblesLegendCommon: 'Most frequent. About 39% of all booster openings are common cards.',
        collectiblesLegendUncommon: 'Rarer than common. About 33% of openings.',
        collectiblesLegendRare: 'Clearly rarer. About 20% of openings.',
        collectiblesLegendMythic: 'Top rarity. About 9% of openings - the chase tier for collectors.',
        ...
        resultProgressNoBaseline: 'Compare - from 2nd run',
        resultProgressBeatPrev: '+{{delta}}% vs last ({{prev}}%→{{curr}}%)',
        resultProgressBehindPrev: '{{delta}}% vs last ({{prev}}%→{{curr}}%)',
        resultProgressTiePrev: 'Same as last: {{prev}}%',
    ...
    ua: {
        ...
        homeMascotHi6: 'Тест на швидкість на хвилину - чесна перевірка, якщо хочеш цифри.',
        homeMascotHi7: 'У мультиплеєрі можна влаштувати дуель - поклич друга, буде веселіше.',
        homeMascotHi8: 'Тема зверху, фон у профілі - підлаштуй настрій, я не проти.',
        homeMascotHi9: 'Уроки копичать нагороди - чим рівніший рядок, тим приємніший прогрес.',
        homeMascotHi10: 'Втомились руки - зроби паузу. Я почекаю, лиш не зникай надовго.',
        homeMascotHi11: 'Сьогодні вистачить і одного закритого уроку - це вже маленька перемога.',
        homeMascotHi12: 'Клавіатура знизу підказує пальці - спокійно дивись на екран.',
        homeMascotHi13: 'Магазин уроків інколи підкидає сюрпризи - зазирни, якщо нудно.',
        homeMascotHi14: 'Не женися за ідеальним стартом - краще рівний ритм, ніж смикатися.',
        homeMascotHi15: 'Помилка не вирок - головне не закипіти і виправити пальці.',
        homeMascotHi16: 'Дихання рівне, плечі нижче вух - так зручніше друкувати довше.',
        homeMascotHi17: 'Застряв на уроку - перемкнись на хвилину у вільний режим.',
        homeMascotHi18: 'Досягнення цікаві - зазирни в профіль, коли буде настрій.',
        homeMascotHi19: 'Мультиплеєр терплячий: можна зібратися без поспіху і наздогнати потім.',
        homeMascotHi20: 'Звук кліків можна вимкнути - я не ображуся, комусь так спокійніше.',
        homeMascotHi21: 'Головна - твій лобі: звідси в усі режими без зайвих кліків.',
        homeMascotHi22: 'Розкладку не забувай перемикати - я колись ледь не потрапила в капс.',
        homeMascotHi23: 'Коротка сесія краща за жодної - п\'ять хвилин теж рахуються.',
        homeMascotHi24: 'Точність інколи важливіша за швидкість - нерви скажуть дякую.',
        homeMascotHi25: 'Урок із підказками рук - дивись на екран, не на пальці, звикнеш.',
        homeMascotHi26: 'Прогрес зберігається - можеш закрити вкладку й повернутися, шлях не скинеться.',
        homeMascotHi27: 'Якщо друг онлайн - кинь лінк на мультиплеєр, посперечаєтесь чесно.',
        homeMascotHi28: 'Нагороди за серію днів копляться - не ламай ланцюжок просто так.',
        homeMascotHi29: 'Вільний друк приймає свій текст - конспект, нотатки, що завгодно.',
        homeMascotHi30: 'Я тут не суддя - темп обираєш ти, я просто вболіваю.',
        chooseDifficulty: 'Оберіть рівень складності',
        chooseDifficultyEpic: 'Сюжетна кампанія',
        lessonsSagaCampaignLine: 'Три акти, один задум: від першої літери до фіналу сезону. Мову уроків (RU/EN/UA) обираєш ти, ланцюг і нагороди - твої.',
        chapterBannerAriaFallback: 'Сюжетна глава.',
        chapterBriefingCombinedObjective: '{{n}} місій на карті. {{goal}}',
        chapterBriefingTrackLine: 'Базовий трек цієї глави: {{done}} / {{total}}.',
        sagaHubPulseTitle: 'Статус кампанії (мова уроків)',
        sagaHubChapter1: 'Глава I',
        sagaHubChapter2: 'Глава II',
        sagaHubChapter3: 'Глава III',
        sagaHubProgressPiece: '{{done}} / {{total}}',
        sagaHubLockedPiece: 'закрита',
        tierLockTeaserMedium: 'Всередині чекають великі літери, довгі відрізки і темп як на трасі.',
        tierLockTeaserAdvanced: 'Всередині чекають розділові знаки, марафони і справжній фінал сезону.',
        sagaToastChapter2Unlocked: 'Главу II відкрито. Режим перегрузу на зв\'язку.',
        sagaToastChapter3Unlocked: 'Главу III у доступі. Точка неповернення - твій виклик.',
        sagaToastCampaignComplete: 'Кампанію на цій розкладці уроків закрито. Ти пройшов увесь сюжет.',
        resultCampaignNextHint: 'Наступна місія вже на карті - не дай їй охолонути.',
        chapterCodenameBeginner: 'Глава I // Протокол пробудження',
        chapterTitleBeginner: 'Перший контакт',
        chapterHookBeginner: 'Система виводить тебе з режиму сну. Запам’ятай ряди, відчуй ритм - тут починається легенда про швидкість.',
        chapterObjectiveBeginner: 'Освоїти базу, зібрати впевненість і відкрити шлях до середнього рівня.',
        chapterCardHookBeginner: 'Тихий старт. Система вчить не поспішати і не помилятися.',
        chapterCodenameMedium: 'Глава II // Режим перегрузу',
        chapterTitleMedium: 'Розгін без гальм',
        chapterHookMedium: 'Полігон розігрівається: довші тексти, вищий темп. Мізок і пальці синхронізуються - ти вже не новачок.',
        chapterObjectiveMedium: 'Прокачати швидкість, тримати точність і підготуватися до фінального рубежу.',
        chapterCardHookMedium: 'Темп росте. Кожна місія - як коло на трасі.',
        chapterCodenameAdvanced: 'Глава III // Точка неповернення',
        chapterTitleAdvanced: 'Адреналін і боси',
        chapterHookAdvanced: 'Лише для тих, хто готовий палити клавіші. Тут вирішують характер, витривалість і точність до останнього знака.',
        chapterObjectiveAdvanced: 'Закріпити майстерність, витримати марафони і бити рекорди без виправдань.',
        chapterCardHookAdvanced: 'Фінал сезону. Або ти тягнеш заїзд, або текст тягне тебе.',
        lessonsSagaUnlockLine: 'Уроки відкриваються по ланцюгу: пройди попередній, щоб розблокувати наступний. Нова глава кампанії (середній рівень і вище) - після повної попередньої на цій розкладці.',
        lessonLockedToast: 'Спочатку пройди попередній урок за сюжетом.',
        ...
        sagaBeat1: 'Ритм вирівняно. Наступний блок перевірить, чи пальці пам’ятають шлях.',
        sagaBeat2: 'Канал стабільніший. Навантаження росте, а ти тримаєш лінію.',
        sagaBeat3: 'Темп піднімається. Дихай рівно, друкуй чистіше, не зривайся.',
        sagaBeat4: 'Ядро сюжету: тут перевіряють характер і витривалість.',
        sagaBeat5: 'Фінішна пряма акту. Покажи, що м’язова пам’ять уже твоя.',
        sagaBeatBeginner0: 'Пробудження: перша літера в ланцюгу не чекає виправдань.',
        sagaBeatBeginner1: 'Базовий ряд стає на місця - слухай такт системи.',
        sagaBeatBeginner2: 'Верх і низ підключаються до мережі. Не відривай погляд від рядка.',
        sagaBeatBeginner3: 'Кожен знак - точка на маршруті. Ти вже всередині місії.',
        sagaBeatBeginner4: 'Ритм уроків щільніший - м’язова пам’ять прокидається.',
        sagaBeatBeginner5: 'Кінець акту: доведи, що руки пам’ятають шлях без карти.',
        sagaBeatMedium0: 'Перегруз: Shift і довжина рядка міняють правила.',
        sagaBeatMedium1: 'Темп росте - слабкі помилки коштують дорожче.',
        sagaBeatMedium2: 'Канал тримається, якщо дихаєш рівно і не зриваєш фокус.',
        sagaBeatMedium3: 'Тут перевіряють: ти ще новачок чи вже боєць клавіатури.',
        sagaBeatMedium4: 'Пік акту - довгі відрізки без паніки.',
        sagaBeatMedium5: 'Фінал ближче до глави III. Не зливай темп на останніх метрах.',
        sagaBeatAdvanced0: 'Точка неповернення: розділові знаки, довжина, нерви.',
        sagaBeatAdvanced1: 'Текст тисне - ти тиснеш у відповідь. Шукай баланс.',
        sagaBeatAdvanced2: 'Марафон без права на слабкість.',
        sagaBeatAdvanced3: 'Тут не «спробував» - або клір, або ні.',
        sagaBeatAdvanced4: 'Майже біля фіналу сезону. Покажи характер.',
        sagaBeatAdvanced5: 'Фінал кампанії на цій розкладці. Заслужи титул.',
        ...
        profileNicknameEmpty: 'Вкажіть нікнейм',
        ...
        collectiblesNewCard: 'Нова карта!',
        collectiblesDuplicate: 'Дублікат - компенсація монетами',
        collectiblesOpenError: 'Не вдалося відкрити бустер',
        collectiblesLogin: 'Увійди, щоб збирати карти.',
        collectiblesClose: 'Круто!',
        collectiblesHomeDesc: 'Бустери, рідкості й бонус до монет',
        collectiblesChanceValue: 'Шанс: {{pct}}%',
        collectiblesCardChanceTitle: 'Прихована карта. Шанс із бустера: {{pct}}%.',
        collectiblesFlipMicro: 'Один бустер - один дроп',
        collectiblesBooster10: '10 бустерів',
        collectiblesBooster50: '50 бустерів',
        collectiblesBatchTitle: 'Відкрито бустерів: {{n}}',
        collectiblesBatchSummary: 'Нових: {{newN}}, дублікатів: {{dupN}}, компенсація: +{{coins}} монет',
        collectiblesBatchNew: 'Нова',
        collectiblesBatchDup: 'Дублікат',
        collectiblesBatchToast: '+{{coins}} монет · нових {{newN}}, дублікатів {{dupN}}',
        collectiblesBatchClose: 'Закрити',
        collectiblesRarity_common: 'Звичайна',
        collectiblesRarity_uncommon: 'Незвичайна',
        collectiblesRarity_rare: 'Рідкісна',
        collectiblesRarity_mythic: 'Міфічна',
        collectiblesLegendTitle: 'Рідкості і дроп',
        collectiblesLegendLead: 'Кожне відкриття бустера видає одну випадкову карту. У карти в колоді є вага: чим далі вона за порядком у сітці, тим нижча вага і тим рідше вона випадає. Нижче - чотири рівні і частка всіх відкриттів по ярусу (сума шансів карт цього рівня).',
        collectiblesLegendCommon: 'Найчастіші. Близько 39% усіх відкриттів бустера - звичайні карти.',
        collectiblesLegendUncommon: 'Рідші за звичайні. Близько 33% відкриттів.',
        collectiblesLegendRare: 'Помітно рідші. Близько 20% відкриттів.',
        collectiblesLegendMythic: 'Топ рідкість. Близько 9% відкриттів - полюють колекціонери.',
        ...
        resultProgressNoBaseline: 'Порівняння - з 2-го заходу',
        resultProgressBeatPrev: '+{{delta}}% до минулого ({{prev}}%→{{curr}}%)',
        resultProgressBehindPrev: '{{delta}}% до минулого ({{prev}}%→{{curr}}%)',
