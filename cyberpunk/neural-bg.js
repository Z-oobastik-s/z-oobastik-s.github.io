// Neural Network Background Animation - Optimized
class NeuralNetwork {
    constructor(canvas) {
        this.canvas = canvas;
    ...
    init() {
        ...
        const nodeCount = Math.min(50, Math.floor((this.canvas.width * this.canvas.height) / 20000));
    ...
    draw() {
        ...
        this.ctx.strokeStyle = 'rgba(0, 255, 159, 0.1)';
